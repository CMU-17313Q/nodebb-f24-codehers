...
<button class="buttonSidebar" onclick="openForm()">Submit bug/feedback</button>
...
<div class="form-popup" id="bug-feedback-modal" style="display:none;">
  <form id="bug-feedback-form" class="form-container" ">
    ...
    <button type="button" class="btn btn-danger cancel buttonSidebar" onclick="closeForm()">Close</button>
  </form>
</div>
...
<style>
  ...
  .form-container .buttonSidebar {
    background-color: pink; /* Change to red or pink */
  ...
  .form-container .submit-feedback:hover {
