...
<button id="submit-bug-feedback" class="btn buttonSidebar" onclick="openForm()">Submit bug/feedback</button>


<!-- The Form Modal -->
<div class="form-popup" id="bug-feedback-modal" style="display:none;">
  <form id="bug-feedback-form" class="form-container" " action="/api/admin/submit-bug" method="POST">
    <h1>Bug/Feedback</h1>
    ...
    <textarea placeholder="Enter Description" id="description" name="description" class="form-control" required></textarea>
...
<script>
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    form.onsubmit = function(event) {
      ...
      console.log("Submitted the form :p yay !");
      ...
      const csrfToken = 25c3e3378391abeb49587cf2dbaee87d963e77fa9561a54c91fce4440ea47befadba39e2a2fc98eeaeafb7c7dc3b4db8ac42640c1aaf845994a21139443a6b57';
      console.log(csrfToken)

      fetch('/api/admin/submit-bug', {
        method: 'POST',
        headers: {
       ...
       body: JSON.stringify({ title, description}) // Convert the form data to JSON
        ...
        if (response.ok) {
          ...
          closeForm();
          // Redirect to the bug archive page after successful submission
          //window.location.href = '/admin/get-bug-archive';
        } else {
