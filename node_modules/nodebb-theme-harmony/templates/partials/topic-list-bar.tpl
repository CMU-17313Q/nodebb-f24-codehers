		...
		<div class="d-flex flex-row p-2 text-bg-light gap-1 border rounded w-100 align-items-center">
			<div component="category/controls" class="d-flex me-auto mb-0 gap-2 flex-wrap">
				...
				<a href="/resources-button" class="btn btn-ghost-sm d-flex align-items-center gap-2" id="custom-button">
					...
					<script>
						function updateResourcesButton() {
							...
							fetch('/api/resources/links')
								...
								.then(data => {
									...
									if (links.length > 0) {
										document.getElementById('custom-button').style.display = 'flex';
									} else {
						...
						// Re-check when a new post is created
						document.addEventListener('postCreated', updateResourcesButton);

						// Use MutationObserver to detect changes in the DOM
						const observer = new MutationObserver(updateResourcesButton);
