	...
	<div class="category d-flex flex-column {{{if widgets.sidebar.length }}}col-lg-9 col-sm-12{{{ else }}}col-lg-12{{{ end }}}">
		...
		<div class="d-flex justify-content-center my-3">
			<div class="input-group" style="max-width: 400px;"> 
				<input type="text" class="form-control form-control-sm" id="search-topic" placeholder="Search topics..." aria-label="Search topics">
				<button class="btn btn-primary btn-sm" type="button" aria-label="[[global:search]]">
							<i component="topic/search/icon" class="fa fa-search"></i>
				</button>
			</div>
		</div>
