<div class="title-container align-items-center gap-2 d-flex">
	...
	<div data-component="composer/title" class="position-relative flex-1" style="min-width: 0;">
		{{{ if isTopicOrMain }}}
		<input class="title form-control h-100 rounded-1 shadow-none" type="text" placeholder="[[topic:composer.title-placeholder]]" value="{topicTitle}" style="width: calc(100% - 100px);"/>
		{{{ else }}}
